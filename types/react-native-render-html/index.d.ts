...
declare module "react-native-render-html" {
  ...
  namespace HTML {
    ...
    interface ContainerProps<P = {}> {
      ...
      /**
       * The width of the HTML content to display. The recommended practice
       * is to pass `useWindowDimensions().width` minus any padding or margins.
       */
      contentWidth?: number;
      /**
