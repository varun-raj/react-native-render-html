...
| `contentWidth`                   | The width of the HTML content to display. The recommended practice is to pass [`useWindowDimensions().width`](https://reactnative.dev/docs/usewindowdimensions) minus any padding or margins. | `number`                      | Optional, defaults to `Dimensions.window().width`            |
